...
class Button_27Owner: NSObject {
    ...
    lazy var button0: UIButton = {
        ...
        view.contentHorizontalAlignment = .center
        view.contentVerticalAlignment = .center
        view.setTitle("Default Text", for: .normal)
        view.setTitle("Disabled Text", for: .disabled)
        view.setTitle("Selected Text", for: .selected)
        view.setTitle("Highlighted Text", for: .highlighted)
        return view
    }()
    var contentView: UIView {
        return button0
